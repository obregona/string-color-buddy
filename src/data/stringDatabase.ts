...
export const COLORS = [
  ...
  { label: "Purple/Gold Spiral", value: "repeating-linear-gradient(45deg, #9333EA, #9333EA 6px, #CA8A04 6px, #CA8A04 8px)" },
...
export const STRING_DATABASE: StringSet[] = [
  ...
  },
 {
  ...
  },
  {
    ...
    strings: [
      { note: "A", peg: "#8B5CF6", pegLabel: "Violet", ballEnd:"repeating-linear-gradient(45deg, #F97316, #F97316 6px, #000000 6px, #000000 8px)", ballEndLabel: "Orange/Black Spiral" },
      { note: "E", peg: "#16A34A", pegLabel: "Green", ballEnd: "repeating-linear-gradient(45deg, #F97316, #F97316 6px, #000000 6px, #000000 8px)", ballEndLabel: "Orange/Black Spiral" },
      { note: "B", peg: "#EAB308", pegLabel: "Yellow", ballEnd: "repeating-linear-gradient(45deg, #F97316, #F97316 6px, #000000 6px, #000000 8px)", ballEndLabel: "Orange/Black Spiral" },
      { note: "F#", peg: "#2563EB", pegLabel: "Blue", ballEnd: "repeating-linear-gradient(45deg, #F97316, #F97316 6px, #000000 6px, #000000 8px)", ballEndLabel: "Orange/Black Spiral" },
    ],
  },
   {
    brand: "Pirastro",
    ...
    strings: [
      { note: "A", peg: "#BAE6FD", pegLabel: "Light Blue", ballEnd:"repeating-linear-gradient(45deg, #FFFFFF, #FFFFFF 6px, #78350F 6px, #78350F 8px)", ballEndLabel: "White/Brown Spiral" },
      { note: "E", peg: "#16A34A", pegLabel: "Green", ballEnd: "repeating-linear-gradient(45deg, #FFFFFF, #FFFFFF 6px, #78350F 6px, #78350F 8px)", ballEndLabel: "White/Brown Spiral" },
      { note: "B", peg: "#CA8A04", pegLabel: "Gold", ballEnd: "repeating-linear-gradient(45deg, #FFFFFF, #FFFFFF 6px, #78350F 6px, #78350F 8px)", ballEndLabel: "White/Brown Spiral" },
      { note: "F#", peg: "#2563EB", pegLabel: "Blue", ballEnd: "repeating-linear-gradient(45deg, #FFFFFF, #FFFFFF 6px, #78350F 6px, #78350F 8px)", ballEndLabel: "White/Brown Spiral" },
    ],
  },
     {
    brand: "Pirastro",
    ...
    strings: [
      { note: "A", peg: "#92400E", pegLabel: "Brown", ballEnd: "repeating-linear-gradient(45deg, #FDE047, #FDE047 6px, #1E40AF 6px, #1E40AF 8px)", ballEndLabel: "Yellow/Blue Spiral" },
      ...
      { note: "B", peg: "#DC2626", pegLabel: "Red", ballEnd: "repeating-linear-gradient(45deg, #FDE047, #FDE047 6px, #1E40AF 6px, #1E40AF 8px)", ballEndLabel: "Yellow/Blue Spiral" },
      { note: "F#", peg: "#DC2626", pegLabel: "Red", ballEnd: "repeating-linear-gradient(45deg, #FDE047, #FDE047 6px, #1E40AF 6px, #1E40AF 8px)", ballEndLabel: "Yellow/Blue Spiral" },
    ],
  },
     {
    brand: "Pirastro",
    ...
    strings: [
      { note: "A", peg: "#BAE6FD", pegLabel: "Light Blue", ballEnd: "repeating-linear-gradient(45deg, #FDE047, #FDE047 6px, #1E40AF 6px, #1E40AF 8px)", ballEndLabel: "Yellow/Blue Spiral" },
      { note: "E", peg: "#16A34A", pegLabel: "Green", ballEnd: "repeating-linear-gradient(45deg, #FDE047, #FDE047 6px, #1E40AF 6px, #1E40AF 8px)", ballEndLabel: "Yellow/Blue Spiral" },
      { note: "B", peg: "#CA8A04", pegLabel: "Gold", ballEnd: "repeating-linear-gradient(45deg, #FDE047, #FDE047 6px, #1E40AF 6px, #1E40AF 8px)", ballEndLabel: "Yellow/Blue Spiral" },
      { note: "F#", peg: "#2563EB", pegLabel: "Blue", ballEnd: "repeating-linear-gradient(45deg, #FDE047, #FDE047 6px, #1E40AF 6px, #1E40AF 8px)", ballEndLabel: "Yellow/Blue Spiral" },
    ],
  },
  {
    brand: "D'Addario",
    model: "Helicore Solo",
    strings: [
      { note: "A", peg: "#DC2626", pegLabel: "Red", ballEnd: "repeating-linear-gradient(45deg, #9333EA, #9333EA 6px, #CA8A04 6px, #CA8A04 8px)", ballEndLabel: "Purple/Gold Spiral" },
      { note: "E", peg: "#EAB308", pegLabel: "Yellow", ballEnd: "repeating-linear-gradient(45deg, #9333EA, #9333EA 6px, #CA8A04 6px, #CA8A04 8px)", ballEndLabel: "Purple/Gold Spiral" },
      { note: "B", peg: "#1C1917", pegLabel: "Black", ballEnd: "repeating-linear-gradient(45deg, #9333EA, #9333EA 6px, #CA8A04 6px, #CA8A04 8px)", ballEndLabel: "Purple/Gold Spiral" },
      { note: "F#", peg: "#16A34A", pegLabel: "Green", ballEnd: "repeating-linear-gradient(45deg, #9333EA, #9333EA 6px, #CA8A04 6px, #CA8A04 8px)", ballEndLabel: "Purple/Gold Spiral" },
    ],
  },
{
  ...
  },
  {
  ...
  },
   {
    ...
    model: "Kaplan Solo",
    strings: [
      { note: "A", peg: "#1C1917", pegLabel: "Black", ballEnd: "repeating-linear-gradient(45deg, #4B5563, #4B5563 6px, #A8A29E 6px, #A8A29E 8px)", ballEndLabel: "Dark Grey/Silver Spiral" },
      { note: "E", peg: "#16A34A", pegLabel: "Green", ballEnd: "repeating-linear-gradient(45deg, #4B5563, #4B5563 6px, #A8A29E 6px, #A8A29E 8px)", ballEndLabel: "Dark Grey/Silver Spiral" },
      { note: "B", peg: "#2563EB", pegLabel: "Blue", ballEnd: "repeating-linear-gradient(45deg, #4B5563, #4B5563 6px, #A8A29E 6px, #A8A29E 8px)", ballEndLabel: "Dark Grey/Silver Spiral" },
      { note: "F#", peg: "#A8A29E", pegLabel: "Silver", ballEnd: "repeating-linear-gradient(45deg, #4B5563, #4B5563 6px, #A8A29E 6px, #A8A29E 8px)", ballEndLabel: "Dark Grey/Silver Spiral" },
    ],
  },
      {
    brand: "Thomastik-Infeld",
